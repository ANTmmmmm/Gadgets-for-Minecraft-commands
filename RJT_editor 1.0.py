...
with open('RJTeditorIcon.ico','wb+') as f:
    imgres = requests.get('http://ant-nest.xyz/Gadgets-for-Minecraft-commands/*Website*/RJTeditorIcon.ico')
...
root.iconbitmap('RJTeditorIcon.ico')
